...
noise_series = [
    Noise_Param(MFN=0.05, EN=0.05, WGN=0.025, mHS=0.00, LDI=0, LDI_num=60/20, LDI_len=(500,1500), LDI_frq=(80,fs/2), name="-4_1"),
    Noise_Param(MFN=0.05, EN=0.05, WGN=0.025, mHS=0.10, LDI=0, LDI_num=60/20, LDI_len=(500,1500), LDI_frq=(80,fs/2), name="-4_3"),
    Noise_Param(MFN=0.1,  EN=0.10, WGN=0.050, mHS=0.35, LDI=0, LDI_num=60/20, LDI_len=(500,1500), LDI_frq=(80,fs/2), name="-8_1"),
]
...
fetal_series = [
    ...
    PCG_Param(HR_MEAN=135, HR_SD=3,
              ...
              HS_F1=FREQ[34][0], HS_SD1=8.64,  HS_S1D=85, HS_S1D_d=12,
              HS_F2=FREQ[34][1], HS_SD2=17.81, HS_S2D=58, HS_S2D_d=9,
              HS_S1S2R=1.70, HS_S1S2R_d=0.71, HS_S1_amp=0.7, HS_AS1=0.12, name="34_135_3"),
    PCG_Param(HR_MEAN=130, HR_SD=2,
              HR_SIG_1=5*fhr_sig2, HR_C1=0.01, HR_F1=0.1,
              HR_SIG_2=fhr_sig2,   HR_C2=0.03, HR_F2=0.25,
              HS_START=37,
              HS_F1=FREQ[36][0], HS_SD1=8.64,  HS_S1D=85, HS_S1D_d=12,
              HS_F2=FREQ[36][1], HS_SD2=17.81, HS_S2D=58, HS_S2D_d=9,
              HS_S1S2R=1.70, HS_S1S2R_d=0.71, HS_S1_amp=0.7, HS_AS1=0.12, name="36_130_2"),
    PCG_Param(HR_MEAN=130, HR_SD=2,
              HR_SIG_1=5*fhr_sig2, HR_C1=0.01, HR_F1=0.1,
              HR_SIG_2=fhr_sig2,   HR_C2=0.03, HR_F2=0.25,
              HS_START=33,
              HS_F1=FREQ[38][0], HS_SD1=8.64,  HS_S1D=85, HS_S1D_d=12,
              HS_F2=FREQ[38][1], HS_SD2=17.81, HS_S2D=58, HS_S2D_d=9,
              HS_S1S2R=1.70, HS_S1S2R_d=0.71, HS_S1_amp=0.7, HS_AS1=0.12, name="38_130_2")
]
