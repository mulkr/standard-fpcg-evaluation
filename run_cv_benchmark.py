...
# Ground truth
GT = benchmark.get_detections("/home/mulkr/PhD/fpcg-gen/normal")
...
current_methods = [
    benchmark.method("Müller",*benchmark.get_detections("/home/mulkr/PhD/fpcg-gen/eval/muller_cv")),
    benchmark.method("Springer",*benchmark.get_detections("/home/mulkr/PhD/fpcg-gen/eval/springer_cv")),
    benchmark.method("Cesarelli",*benchmark.get_detections("/home/mulkr/PhD/fpcg-gen/eval/cesarelli")),
    benchmark.method("Balogh",*benchmark.get_detections("/home/mulkr/PhD/fpcg-gen/eval/balogh")),
    benchmark.method("Schmidt",*benchmark.get_detections("/home/mulkr/PhD/fpcg-gen/eval/schmidt_cv")),
    benchmark.method("Renna-1",*benchmark.get_detections("/home/mulkr/PhD/fpcg-gen/eval/renna_seqmax_cv")),
    benchmark.method("Renna-2",*benchmark.get_detections("/home/mulkr/PhD/fpcg-gen/eval/renna_hsmm_cv")),
    benchmark.method("Chen",*benchmark.get_detections("/home/mulkr/PhD/fpcg-gen/eval/chen")),
]
