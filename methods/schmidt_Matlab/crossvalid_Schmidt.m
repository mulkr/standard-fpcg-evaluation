function [B_mats, pi_vecs] = crossvalid_Schmidt(input_dir, output_dir)
    FOLDS = 10;
    ...
    for k = 1:FOLDS
        ...
        train_ind(test_ind) = [];
        [B_matrix, pi_vector] = ...
            trainSchmidtSegmentationAlgorithm(dats(train_ind),labs(train_ind,:),schmidt_options.audio_Fs, false);
        B_mats{k} = B_matrix;
        pi_vecs{k} = pi_vector;
