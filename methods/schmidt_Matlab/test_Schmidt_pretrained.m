function test_Schmidt_pretrained(test_dir, output_dir, B_matrix, pi_vector)
    ...
    for f = 1:length(test_files)
        ...
        s1_locs = s1_locs/schmidt_options.audio_Fs;
        s2_locs = s2_locs/schmidt_options.audio_Fs;
