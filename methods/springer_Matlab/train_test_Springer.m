function [B_matrix, pi_vector, total_obs_distribution] = train_test_Springer(input_dir, test_dir, output_dir)
    ...
    [B_matrix, pi_vector, total_obs_distribution] = ...
        trainSpringerSegmentationAlgorithm(dats,labs,springer_options.audio_Fs, false); %?
