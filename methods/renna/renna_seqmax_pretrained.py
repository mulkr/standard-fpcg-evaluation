...
from preprocess import renna_preprocess_wave
...
if __name__ == "__main__":
    ...
    test_model = tf.keras.models.load_model("rbio3.9_BP_15-100_tuned_seq_complete.h5") #type:ignore
