...
if __name__ == "__main__":
    ...
    def cv_fold(i,train_ind,test_ind):
        ...
        #     if layer.name.startswith("dec_3"):
        #         break
        ...
        callbacks = []
        checkpoint = ModelCheckpoint(f'{model_name}_{i}_tuned_seq.h5', monitor='loss', verbose=1, save_best_only=True, mode='min')
        ...
        test_model = tf.keras.models.load_model(f"{model_name}_{i}_tuned_seq.h5") #type:ignore
